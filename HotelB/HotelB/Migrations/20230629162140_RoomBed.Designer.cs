...
namespace HotelB.Migrations
{
    ...
    [Migration("20230629162140_RoomBed")]
    partial class RoomBed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelB.DataContext.Entities.RoomBed", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelB.DataContext.Entities.RoomBed", b =>
                {
                    b.HasOne("HotelB.DataContext.Entities.Bed", "Bed")
                        .WithMany("RoomBed")
                        .HasForeignKey("BedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
